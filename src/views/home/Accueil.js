      ...
      <div className={"card2_body_fr"}>
        ...
        <div className={"card2_info_fr"}>
          <div className={"card2_infofo_fr"}>
            <div className={"card2_prix_fr"}>30000 Ar</div>
            <div className={"card2_cat_fr"}>
              <b>Vin rouge</b>
              <br></br>
              Petite description
            </div>
            <div className={"card2_qt_fr"}>Stock: 243</div>
          </div>

          <div className={"card2_contim_fr"}>
            <img src={front_im} className={"card2_im2_fr"}></img>
          </div>
        </div>
      </div>
      <div className={"card2_foot_fr"}>Vin Château Janon Rouge</div>
    </div>
  );
